...
password:{
    ...
    patterMismatch: "Al menos 6 caracteres, debe contener una letra minúscula, una letra mayúscula, un número y no puede contener caracteres especiales"
  },
nacimiento: {
  ...
  estado: {
    valueMissing: "Este campo no puede estar vacío",
    patterMismatch: "La estado debe contener entre 10 a 40 caracteres.",
  },
};
